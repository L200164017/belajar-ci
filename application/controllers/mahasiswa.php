...
class Mahasiswa extends CI_Controller{
    ...
    public function excel()
    {
        ...
        $object->getProperties()->setCreator('Nadhif');
        $object->getProperties()->setLastModifiedBy('Nadhif');
        $object->getProperties()->setTitle('Daftar Mahasiswa');

        $object->setActiveSheetIndex(0);

        $object->getActiveSheet()->setCellValue('AI','NO');
        $object->getActiveSheet()->setCellValue('AI','Nama Mahasiswa');
        $object->getActiveSheet()->setCellValue('AI','Jurusan');
        $object->getActiveSheet()->setCellValue('AI','NO');
        $object->getActiveSheet()->setCellValue('AI','NO');
        $object->getActiveSheet()->setCellValue('AI','NO');
        $object->getActiveSheet()->setCellValue('AI','NO');
